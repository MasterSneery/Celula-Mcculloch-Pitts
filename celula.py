...
class McCullochPitts():
    ...
    def _tabla_de_verdad(self, n_bits, compuerta = "AND"):
        """Genera la tabla de verdad para la compuerta que se le pasa como parametro y de acuerdo a la cantidad de bits"""
        matrix = []
        aux = []
        tt = []
    ...
    def _fit(self):
        """Intenta encontrar los pesos y umbral de la Neurona"""
        import json
        correct = False
        pesos_sinapticos = []
        actual_epoch = 0
